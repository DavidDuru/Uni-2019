...
require(ggplot2)
require(stringr)
explore<- read_excel("~/GitHub/Uni-2019/Uni - Sem 1 - 2019/AMED3002/clinical_2014-01-16.xlsx")
colnames(explore)
glimpse(explore)
...
df3$monthsSurvived <- log(df3$monthsSurvived)
...
library(ggbiplot)
library("factoextra")
pca2 = princomp(dataContinuous, cor = TRUE)

p1 = ggscreeplot(pca2) + theme_bw(base_size = 20) + labs(y = "Prop. of explained variance")
p2 = ggscreeplot(pca2,type = "cev") + theme_bw(base_size = 20) + labs(y = " Cumulative prop. of explained variance")
gridExtra::grid.arrange(p1,p2,ncol=2)

summary(pca2)
result <- get_pca_var(pca2)
head(result$contrib)
